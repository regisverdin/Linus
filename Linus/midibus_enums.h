...
{
    eMidiBusInterfaceModeSource = 0,             // interface is MIDI source only
    eMidiBusInterfaceModeDestination = 1,        // interface is MIDI destination only
    eMidiBusInterfaceModeDual = 3                // interface is both source and destination
...
typedef enum enum_MidiBusInterfaceType
{
    ...
    eMidiBusInterfaceTypeVirtual = 3               // interface is virtual
...
typedef enum enum_MidiBusVirtualMode
{
    ...
    eMidiBusVirtualModeInput = 1,               // app only sends (eg. controller sends MIDI)
    eMidiBusVirtualModeOutput = 2,              // app only receives (eg. sound module receives MIDI)
